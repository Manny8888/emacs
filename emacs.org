...
#+BEGIN_SRC emacs-lisp
  ...
  (bind-key "<XF86AudioMute>" #'my/mute)
  ...
  (bind-key "<XF86AudioRaiseVolume>" #'my/volume-up)
  ...
  (bind-key "<XF86AudioLowerVolume>" #'my/volume-up)
  ...
  (bind-key "<XF86AudioMicMute>" #'my/mute-mic)
  ...
  (bind-key "<XF86MonBrightnessUp>" #'my/brightness-up)
  (bind-key "<XF86MonBrightnessDown>" #'my/brightness-down)
#+END_SRC
